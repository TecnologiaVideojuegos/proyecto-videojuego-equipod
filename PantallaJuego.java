...
public class PantallaJuego extends BasicGameState
{
    ...
    private Image energia1, energia2, vida1, vida2, player1, player2;
    ...
    private boolean player1Over, player2Over;
    ...
    public void init(GameContainer container, StateBasedGame game) throws SlickException 
    {
        ...
        try 
        {
            ...
            fuente.loadGlyphs();
            Font fuenteUAX2 = java.awt.Font.createFont(java.awt.Font.TRUETYPE_FONT, org.newdawn.slick.util.ResourceLoader.getResourceAsStream("fonts/Hellgrazer.otf"));
            fuenteUAX2 = fuenteUAX.deriveFont(java.awt.Font.PLAIN, 16);
            fuente2 = new UnicodeFont(fuenteUAX2);
            fuente2.addAsciiGlyphs();
            ColorEffect color2 = new ColorEffect(java.awt.Color.BLACK);
            fuente2.getEffects().add(color2);
            fuente2.loadGlyphs();
        } 
        ...
        player1 = new Image("res/circulo azul.png");
        player2 = new Image("res/circulo azul.png");
    ...
    public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException 
    {
        ...
        player1.draw(5, 220, 80, 80);
        fuente.drawString(20, 240, "J1");
        player2.draw(1200, 220, 80, 80);
        fuente.drawString(1215, 240, "J2");;
        ...
        fuente.drawString(510, 75, "TURNO JUGADOR "+partida.getP_turn());
        
        if(unitSelected == null)
        {
            fuente.drawString(280, 400, "UNIDAD : N/A");
        }
        else
        {
            fuente.drawString(280, 400, "UNIDAD : " + unitSelected.getName());
        }
        if(targetSelected == null)
        {
            fuente.drawString(780, 400, "OBJETIVO : N/A");
        }
        else
        {
            fuente.drawString(780, 400, "OBJETIVO : " + targetSelected.getName());
        }
    ...
    public void update(GameContainer container, StateBasedGame game, int delta) throws SlickException 
    {
        ...
        if(raton.isKeyPressed(Input.KEY_ESCAPE))
        {
            game.enterState(4);
        }
    }
    ...
    public void ratonSobreBoton()
    {
        ...
        player1Over = ((raton.getMouseX()>=5&&raton.getMouseY()>=220)&&(raton.getMouseX()<=85&&raton.getMouseY()<=300));
        player2Over = ((raton.getMouseX()>=1200&&raton.getMouseY()>=220)&&(raton.getMouseX()<=1280&&raton.getMouseY()<=300));
    }
        ...
        if(ratonPress)
        {
            if(player2Over)
            {
                if(partida.getP_turn() == 1)
                {
                    if(unitSelected != null)
                    {
                        GameMethods.executeAttackToPlayer(unitSelected);
                        if(partida.getP2_health() <= 0)
                        {
                            game.enterState(2);
                        }
                    }
            ...
            if(unit1Over)
            {
                ...
                else
                {
                    if(unitSelected != null)
                    {
                        ...
                        GameMethods.executeAttack(unitSelected, targetSelected);
    ...
    public void dragAndDrop() throws SlickException
    {
        if(ratonPulsado)
        {
            if((raton.getMouseX()>=x1&&raton.getMouseX()<=x1+110)&&(raton.getMouseY()>=y1&&raton.getMouseY()<=y1+150))
            {
                ...
                if(partida.getP1_hand().size() >= 1 && partida.getP_turn() == 1)
                {
                    invocacionPosible = true;
                    unidadSeleccionada = partida.getP1_hand().get(0);
                }
                else if(partida.getP2_hand().size() >= 1 && partida.getP_turn() == 2)
                {
                    invocacionPosible = true;
            ...
            if((raton.getMouseX()>=x2&&raton.getMouseX()<=x2+110)&&(raton.getMouseY()>=y2&&raton.getMouseY()<=y2+150))
            {
                ...
                if(partida.getP1_hand().size() >= 2 && partida.getP_turn() == 1)
                {
                    invocacionPosible = true;
                    unidadSeleccionada = partida.getP1_hand().get(1);
                }
                else if(partida.getP2_hand().size() >= 2 && partida.getP_turn() == 2)
                {
                    invocacionPosible = true;
            ...
            if((raton.getMouseX()>=x3&&raton.getMouseX()<=x3+110)&&(raton.getMouseY()>=y3&&raton.getMouseY()<=y3+150))
            {
                ...
                if(partida.getP1_hand().size() >= 3 && partida.getP_turn() == 1)
                {
                    invocacionPosible = true;
                    unidadSeleccionada = partida.getP1_hand().get(2);
                }
                else if(partida.getP2_hand().size() >=3 && partida.getP_turn() == 2)
                {
                    invocacionPosible = true;
            ...
            if((raton.getMouseX()>=x4&&raton.getMouseX()<=x4+110)&&(raton.getMouseY()>=y4&&raton.getMouseY()<=y4+150))
            {
                ...
                if(partida.getP1_hand().size() >= 4 && partida.getP_turn() == 1)
                {
                    invocacionPosible = true;
                    unidadSeleccionada = partida.getP1_hand().get(3);
                }
                else if(partida.getP2_hand().size() >= 4 && partida.getP_turn() == 2)
                {
                    invocacionPosible = true;
            ...
            if((raton.getMouseX()>=x5&&raton.getMouseX()<=x5+110)&&(raton.getMouseY()>=y5&&raton.getMouseY()<=y5+150))
            {
                ...
                if(partida.getP1_hand().size() >= 5 && partida.getP_turn() == 1)
                {
                    invocacionPosible = true;
                    unidadSeleccionada = partida.getP1_hand().get(4);
                }
                else if(partida.getP2_hand().size() >= 5 && partida.getP_turn() == 2)
                {
                    invocacionPosible = true;
    ...
    public void dibujarEnTablero()
    {
        ...
        switch (partida.getP1_table().size())
        {
            ...
            case 5:
                ...
                fuente2.drawString(125, 170, partida.getP1_table().get(0).getHealth()+"");
                fuente2.drawString(165, 170, partida.getP1_table().get(0).getDamage()+"");
                imagenMesa1_2 = partida.getP1_table().get(1).getRutaImagenMesa();
                imagenMesa1_2.draw(220, 230, 60, 60);
                fuente2.drawString(225, 270, partida.getP1_table().get(1).getHealth()+"");
                fuente2.drawString(265, 270, partida.getP1_table().get(1).getDamage()+"");
                imagenMesa1_3 = partida.getP1_table().get(2).getRutaImagenMesa();
                imagenMesa1_3.draw(120, 330, 60, 60);
                fuente2.drawString(125, 370, partida.getP1_table().get(2).getHealth()+"");
                fuente2.drawString(165, 370, partida.getP1_table().get(2).getDamage()+"");
                imagenMesa1_4 = partida.getP1_table().get(3).getRutaImagenMesa();
                imagenMesa1_4.draw(280, 330, 60, 60);
                fuente2.drawString(285, 370, partida.getP1_table().get(3).getHealth()+"");
                fuente2.drawString(325, 370, partida.getP1_table().get(3).getDamage()+"");
                imagenMesa1_5 = partida.getP1_table().get(4).getRutaImagenMesa();
                imagenMesa1_5.draw(280, 130, 60, 60);
                fuente2.drawString(285, 170, partida.getP1_table().get(4).getHealth()+"");
                fuente2.drawString(325, 170, partida.getP1_table().get(4).getDamage()+"");
                break;
            case 4:
                imagenMesa1_1 = partida.getP1_table().get(0).getRutaImagenMesa();
                imagenMesa1_1.draw(120, 130, 60, 60);
        ...
        switch (partida.getP2_table().size())
        {
            case 5:
                ...
                fuente2.drawString(1105, 170, partida.getP2_table().get(0).getDamage()+"");
                fuente2.drawString(1145, 170, partida.getP2_table().get(0).getHealth()+"");
                imagenMesa2_2 = partida.getP2_table().get(1).getRutaImagenMesa();
                imagenMesa2_2.draw(1060, 230, -60, 60);
                fuente2.drawString(1005, 270, partida.getP2_table().get(1).getDamage()+"");
                fuente2.drawString(1045, 270, partida.getP2_table().get(1).getHealth()+"");
                imagenMesa2_3 = partida.getP2_table().get(2).getRutaImagenMesa();
                imagenMesa2_3.draw(1160, 330, -60, 60);
                fuente2.drawString(1105, 370, partida.getP2_table().get(2).getDamage()+"");
                fuente2.drawString(1145, 370, partida.getP2_table().get(2).getHealth()+"");
                imagenMesa2_4 = partida.getP2_table().get(3).getRutaImagenMesa();
                imagenMesa2_4.draw(1000, 330, -60, 60);
                fuente2.drawString(945, 370, partida.getP2_table().get(3).getDamage()+"");
                fuente2.drawString(985, 370, partida.getP2_table().get(3).getHealth()+"");
                imagenMesa2_5 = partida.getP2_table().get(4).getRutaImagenMesa();
                imagenMesa2_5.draw(1000, 130, -60, 60);
                fuente2.drawString(945, 170, partida.getP2_table().get(3).getDamage()+"");
                fuente2.drawString(985, 170, partida.getP2_table().get(3).getHealth()+"");
                break;
            case 4:
                imagenMesa2_1 = partida.getP2_table().get(0).getRutaImagenMesa();
                imagenMesa2_1.draw(1160, 130, -60, 60);
